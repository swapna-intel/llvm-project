...
void printLitHelper(ExprAST *litOrNum) {
  ...
  llvm::errs() << "<";
  llvm::errs() << literal->getDim();
  //  llvm::interleaveComma(literal->getDim(), llvm::errs());
  llvm::errs() << ">";
